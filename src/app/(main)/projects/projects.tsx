...
export default function ProjectsShowcase() {
  return (
    <div className="h-auto min-h-[30rem] sm:min-h-[35rem] md:min-h-[40rem] flex flex-col items-center justify-center relative overflow-hidden  text-white px-4 sm:px-8">
      {/* Projects Heading */}
      <h2 className="text-3xl sm:text-2xl md:text-3xl uppercase tracking-wide font-bold text-orange-500 mb-8 sm:mb-7 tracking-wide border-b-2 border-orange-400 text-center">
        Featured Projects
      </h2>
